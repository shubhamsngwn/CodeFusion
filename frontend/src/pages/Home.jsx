...
const Home = () => {
    ...
    fetch(api_base_url + "/getProjects", {
      ...
      .then((data) => {
        if (data.success && Array.isArray(data.projects)) {
          setData(data.projects); // Store only the projects array
        } else {
          setError(data.message);
  ...
  return (
    <>
      ...
      <ToastContainer />
      <div className="flex items-center justify-between px-[100px] my-[40px] Shubham">
        <h2 className="text-2xl">
          Hi, {data ? userData.user.username : ""} 👋
        </h2>
